...
public class GeoPoint {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(geoPoint.lat, lat) == 0 &&
                Double.compare(geoPoint.lat, lon) == 0;
    }
...
//-----------------------------------------------------------------------------------
   ...
   /* public static void main(String[] args) {
        ...
        hashMap.put(new GeoPoint(57.9906873, 31.555076) , "Старая Русса");
        System.out.println(hashMap.get(alzamayGP));

        System.out.println("хеш-код alzamayGP = "+alzamayGP.hashCode());

        alzamayGP.lon = 98.664105; // TODO: 01.09.2020    98.6644105;
        System.out.println("хеш-код alzamayGP = "+alzamayGP.hashCode());
...
//хеш-код alzamayGP = -1339609422
//хеш-код alzamayGP = -1376735663
